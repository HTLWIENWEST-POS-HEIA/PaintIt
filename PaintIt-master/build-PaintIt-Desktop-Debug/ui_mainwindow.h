...
public:
    ...
    QToolButton *tbtnFreeze;
    QWidget *verticalLayoutWidget;
    QVBoxLayout *verticalLayout;
    QHBoxLayout *horizontalLayout_2;
    QLabel *lblRadius;
    QSpinBox *spinBox_particleCount;
    QPushButton *pb_fontDialog;
    QHBoxLayout *horizontalLayout_3;
    QLabel *lblRadius_2;
    QSpinBox *spinBox_LineWidth;
    QHBoxLayout *horizontalLayout_4;
    QLabel *lblRadius_3;
    QSpinBox *spinBox_stampSize;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/icons/icons/paintit.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        graphicsView->setMinimumSize(QSize(1024, 0));
        ...
        QIcon icon2;
        icon2.addFile(QStringLiteral(":/icons/icons/stamp.png"), QSize(), QIcon::Normal, QIcon::Off);
        tbtnStamp->setIcon(icon2);
        ...
        QIcon icon3;
        icon3.addFile(QStringLiteral(":/icons/icons/brush.png"), QSize(), QIcon::Normal, QIcon::Off);
        tbtnBrush->setIcon(icon3);
        ...
        QIcon icon4;
        icon4.addFile(QStringLiteral(":/icons/icons/fill.png"), QSize(), QIcon::Normal, QIcon::Off);
        tbtnFill->setIcon(icon4);
        ...
        QIcon icon5;
        icon5.addFile(QStringLiteral(":/icons/icons/text.png"), QSize(), QIcon::Normal, QIcon::Off);
        tbtnText->setIcon(icon5);
        ...
        QIcon icon6;
        icon6.addFile(QStringLiteral(":/icons/icons/spray.png"), QSize(), QIcon::Normal, QIcon::Off);
        tbtnSpray->setIcon(icon6);
        ...
        QIcon icon7;
        icon7.addFile(QStringLiteral(":/icons/icons/swap.png"), QSize(), QIcon::Normal, QIcon::Off);
        tbtnSwapColors->setIcon(icon7);
        tbtnRect = new QToolButton(frame);
        tbtnRect->setObjectName(QStringLiteral("tbtnRect"));
        tbtnRect->setGeometry(QRect(10, 70, 30, 30));
        QIcon icon8;
        icon8.addFile(QStringLiteral(":/icons/icons/rect.png"), QSize(), QIcon::Normal, QIcon::Off);
        tbtnRect->setIcon(icon8);
        ...
        QIcon icon9;
        icon9.addFile(QStringLiteral(":/icons/icons/ellipse.png"), QSize(), QIcon::Normal, QIcon::Off);
        tbtnEllipse->setIcon(icon9);
        ...
        QIcon icon10;
        icon10.addFile(QStringLiteral(":/icons/icons/eraser.png"), QSize(), QIcon::Normal, QIcon::Off);
        tbtnEraser->setIcon(icon10);
        tbtnEraser->setIconSize(QSize(20, 20));
        tbtnUndo = new QToolButton(frame);
        tbtnUndo->setObjectName(QStringLiteral("tbtnUndo"));
        tbtnUndo->setGeometry(QRect(10, 100, 30, 30));
        QIcon icon11;
        icon11.addFile(QStringLiteral(":/icons/icons/undo.png"), QSize(), QIcon::Normal, QIcon::Off);
        tbtnUndo->setIcon(icon11);
        tbtnUndo->setIconSize(QSize(20, 20));
        tbtnFreeze = new QToolButton(frame);
        tbtnFreeze->setObjectName(QStringLiteral("tbtnFreeze"));
        tbtnFreeze->setGeometry(QRect(40, 100, 30, 30));
        QIcon icon12;
        icon12.addFile(QStringLiteral(":/icons/icons/freeze.png"), QSize(), QIcon::Normal, QIcon::Off);
        tbtnFreeze->setIcon(icon12);
        tbtnFreeze->setIconSize(QSize(20, 20));
        verticalLayoutWidget = new QWidget(centralWidget);
        verticalLayoutWidget->setObjectName(QStringLiteral("verticalLayoutWidget"));
        verticalLayoutWidget->setGeometry(QRect(1040, 340, 125, 431));
        ...
        spinBox_particleCount = new QSpinBox(verticalLayoutWidget);
        spinBox_particleCount->setObjectName(QStringLiteral("spinBox_particleCount"));
        QSizePolicy sizePolicy1(QSizePolicy::Fixed, QSizePolicy::Fixed);
        sizePolicy1.setHorizontalStretch(0);
        sizePolicy1.setVerticalStretch(0);
        sizePolicy1.setHeightForWidth(spinBox_particleCount->sizePolicy().hasHeightForWidth());
        spinBox_particleCount->setSizePolicy(sizePolicy1);
        spinBox_particleCount->setMaximum(100);
        spinBox_particleCount->setValue(20);

        horizontalLayout_2->addWidget(spinBox_particleCount);


        verticalLayout->addLayout(horizontalLayout_2);

        pb_fontDialog = new QPushButton(verticalLayoutWidget);
        pb_fontDialog->setObjectName(QStringLiteral("pb_fontDialog"));

        verticalLayout->addWidget(pb_fontDialog);

        horizontalLayout_3 = new QHBoxLayout();
        horizontalLayout_3->setSpacing(6);
        horizontalLayout_3->setObjectName(QStringLiteral("horizontalLayout_3"));
        lblRadius_2 = new QLabel(verticalLayoutWidget);
        lblRadius_2->setObjectName(QStringLiteral("lblRadius_2"));
        lblRadius_2->setFont(font);

        horizontalLayout_3->addWidget(lblRadius_2);
        ...
        lblRadius_3 = new QLabel(verticalLayoutWidget);
        lblRadius_3->setObjectName(QStringLiteral("lblRadius_3"));
        lblRadius_3->setFont(font);

        horizontalLayout_4->addWidget(lblRadius_3);

        spinBox_stampSize = new QSpinBox(verticalLayoutWidget);
        spinBox_stampSize->setObjectName(QStringLiteral("spinBox_stampSize"));
        sizePolicy1.setHeightForWidth(spinBox_stampSize->sizePolicy().hasHeightForWidth());
        spinBox_stampSize->setSizePolicy(sizePolicy1);
        spinBox_stampSize->setMaximum(1000);
        spinBox_stampSize->setValue(200);

        horizontalLayout_4->addWidget(spinBox_stampSize);
    ...
    {
        MainWindow->setWindowTitle(QApplication::translate("MainWindow", "PaintIt! - RIP MS Paint", 0));
        ...
        tbtnUndo->setText(QApplication::translate("MainWindow", "...", 0));
        tbtnFreeze->setText(QApplication::translate("MainWindow", "...", 0));
        lblRadius->setText(QApplication::translate("MainWindow", "Partikel", 0));
        pb_fontDialog->setText(QApplication::translate("MainWindow", "Font-Dialog", 0));
        lblRadius_2->setText(QApplication::translate("MainWindow", "Linienst\303\244rke", 0));
        lblRadius_3->setText(QApplication::translate("MainWindow", "Stempelgr\303\266\303\237e", 0));
